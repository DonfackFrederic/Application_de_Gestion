...
class list_clt:
    def __init__(self,root):
        ...
        self.tab.heading(3,text="Metier")
        self.tab.heading(4,text="Demande")
        ...
        self.cur.execute("SELECT id, nom, metier, demande  FROM client")
        self.result=self.cur.fetchall()
        self.conn.close()
        for clt in self.result:
            self.tab.insert("",END, values=clt)
        #place
        #suppression
