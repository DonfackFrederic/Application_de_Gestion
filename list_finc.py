...
class list_finc:
    def __init__(self,root):
        ...
        #creation du tableau
        self.tab=ttk.Treeview(self.fen, columns=(1,2,3), height=5, show="headings")
        Label(self.fen, text="liste des Depenes", fg="blue2", bg="light cyan", font=("Arial 15")).place(x=400, y=100)
        #headings
        self.tab.heading(1,text="ID")
        self.tab.heading(2,text="Motif")
        self.tab.heading(3,text="cout")
        ...
        self.cur.execute("SELECT id, motif, cout  FROM finance")
